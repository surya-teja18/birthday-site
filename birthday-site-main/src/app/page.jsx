...
import EnhancedBirthdayCard from "@/components/enhanced-birthday-card"
        ...
        <motion.div className="bg-white bg-opacity-80 backdrop-blur-sm rounded-3xl shadow-xl shadow-rose-100 p-8 border-2 border-rose-200"
          ...
          <AnimatePresence mode="wait">
            {!isBirthday ? (
              ...
              <BirthdayCake key="cake" onCakeComplete={handleCakeComplete} />
            ) : showCard ? (
              <EnhancedBirthdayCard key="card" />
            ) : (
